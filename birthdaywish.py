...
class BirthdayWish(loader.Module):
    ...
    strings = {
        "name": "BirthdayWish",
        "provide_name": "<emoji id=5456652110143693064>🤷‍♂️</emoji> <b>Please provide a name</b>",
        "web_url": "<emoji id=5334643333488713810>🌐</emoji> <b>URL: {} | Expires in <code>{}</code> seconds</b>",
        "expired": "<emoji id=5981043230160981261>⏱</emoji> <b>Url Expired</b>",
    }

    strings_ru = {
        "provide_name": "<emoji id=5456652110143693064>🤷‍♂️</emoji> <b>Пожалуйста, укажите имя</b>",
        "web_url": "<emoji id=5334643333488713810>🌐</emoji> <b>URL: {} | Истекает через <code>{}</code> секунд</b>",
        "expired": "<emoji id=5981043230160981261>⏱</emoji> <b>Url истек</b>",
    }
